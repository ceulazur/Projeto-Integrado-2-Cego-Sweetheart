        ...
        <div className="fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-50 px-6 py-8 flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-6 text-gray-800">
            <li className="flex items-center gap-3">
              ...
              <Link to="/home" className="hover:text-blue-500" onClick={() => setIsMenuOpen(false)}>
                Início
              </Link>
            </li>
            <li className="flex items-center gap-3">
              <Squares2X2Icon className="h-5 w-5 text-gray-600" />
              <Link to="/produtos" className="hover:text-blue-500" onClick={() => setIsMenuOpen(false)}>
                Produtos
              </Link>
            </li>
            <li className="flex items-center gap-3">
              <ShoppingBagIcon className="h-5 w-5 text-gray-600" />
              <Link to="/pedidos" className="hover:text-blue-500" onClick={() => setIsMenuOpen(false)}>
                Pedidos
              </Link>
            </li>
          </ul>
